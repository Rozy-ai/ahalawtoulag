...
$this->title = $title;
$this->title .= ' | '.Yii::t('app', 'Questions').' | '.Yii::t('app','Site name');
...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Questions'), 'url' => ['index','language'=>\common\helpers\Language::Language()]];
