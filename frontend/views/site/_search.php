...
<div class="input-group">
    <?= $form->field($model, 'title')->textInput(['autofocus' => false,'placeholder'=>Yii::t('app','Search by site'),'class'=>'form-control', 'style'=>'font-family:Arial, FontAwesome'])->label(false) ?>
